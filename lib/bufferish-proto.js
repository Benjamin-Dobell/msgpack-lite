...
function isBufferShim() {
  return hasBuffer() && ("TYPED_ARRAY_SUPPORT" in getBufferImplementation());
}

function brokenTypedArray() {
  return isBufferShim() && !Buffer.TYPED_ARRAY_SUPPORT;
}
